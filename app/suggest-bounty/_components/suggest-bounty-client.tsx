...
interface SuggestBountyClientProps {
  user: any
}
...
export function SuggestBountyClient({ user }: SuggestBountyClientProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || 'Failed to suggest bounty')
      }

      toast.success('Bounty suggestion submitted successfully! Admins will review it shortly.')
      router.push('/dashboard')

    } catch (error: any) {
      toast.error(error.message || 'Failed to suggest bounty')
    } finally {
      setIsLoading(false)
    }
  }
    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <h1 className="text-4xl font-bold tracking-tight mb-2">
          Suggest a <span className="text-primary">Bounty</span>
        </h1>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Share your bounty idea with the community. Admins will review and potentially approve it.
        </p>
      </div>
      ...
      <Alert>
        ...
        <AlertDescription>
          Your suggestion will be reviewed by admins. If approved, it will become an active bounty with you as the creator, 
          allowing you to manage submissions and select winners.
        </AlertDescription>
      </Alert>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  id="title"
                  placeholder="Enter a clear, descriptive title for your bounty idea"
            ...
            <div className="space-y-4">
              <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Select what types of submissions should be accepted for this bounty
                </p>
            ...
            <div className="flex gap-4 pt-6">
              ...
              <Button
                ...
                disabled={isLoading}
              >
                {isLoading ? 'Submitting...' : 'Suggest Bounty'}
              </Button>
            </div>
          </form>
        </CardContent>
